...
function emailAlertWithText(emailAddress, text) {
  window.open('mailto:' + emailAddress + '?subject=TestMandarake&body='+text);
}
...
function urlSearchString(urlText, strPattern, excludeString) {
  if (urlText.search(strPattern) != -1) {
    ...
    //emailAlertWithText('kunyi731@gmail.com', emailText);
  } else {
